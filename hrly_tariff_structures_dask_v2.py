...
elec_reg_ret_dask = dd.from_pandas(elec_registers.drop(columns=['LogicalRegisterNumber','RateType','State','RetailTariffType','NetworkTariff','NetworkTariffType']),npartitions=10)
elec_reg_nwk_dask = dd.from_pandas(elec_registers.drop(columns=['LogicalRegisterNumber','RateType','State','RetailTariff','RetailTariffType']),npartitions=10)
...
ret_structure = dd.merge(ret_structure,elec_reg_ret_dask,
                            how='inner',left_on='RetailTariff',right_on='RetailTariff')
nwk_structure = dd.merge(nwk_structure,elec_reg_nwk_dask,
