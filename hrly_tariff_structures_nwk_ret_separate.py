...
retail_tariff_set = "select distinct BaselineRetailTariff as RetailTariff from AGL_PRICING.dbo.CONTRACT_ATTRIBUTE"
network_tariff_set = "select distinct BaselineNetworkTariffCode as NetworkTariff from AGL_PRICING.dbo.CONTRACT_ATTRIBUTE"
...
# limit to tariffs in Contract Attribute
...
print("Tariff structure after saving to csv, retail:")
print(ret_structure.dtypes)
print("Tariff structure after saving to csv, network:")
print(nwk_structure.dtypes)

print("Completed creation of netwrk and retail tariff structures at hourly level.")